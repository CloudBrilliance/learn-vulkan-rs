...
impl App {
    ...
    pub unsafe fn create(window: &Window) -> Result<Self> {
        ...
        // 2. Create a uniform buffer for each image view
        buffers::create_uniform_buffers(&instance, &device, &mut data)?;
        // 3. Create descriptor pool
        // Descriptor sets cannot be created directly and need to be allocated by a descriptor pool.
        ...
        // 5. Bind the corresponding descriptor set to each swapchain image
    ...
    unsafe fn update_uniform_buffer(&self, image_index: usize) -> Result<()> {
        ...
        // The GLM library was originally designed for OpenGL, 
        // and its Y-axis coordinate is the opposite of Vulkan. 
        // Therefore, set the Y-axis scaling factor of the projection matrix to -1.
        proj[1][1] *= -1.0;
